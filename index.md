...
venue: "UoBham"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Some Road"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "52.452886,-1.929605"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "22-23 January 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["James Carpenter", "Simon Branford"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Bob Brunel"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["me@example.org.com.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<h4>This workshop is full. Only those with a confirmed place may attend.</h4>
